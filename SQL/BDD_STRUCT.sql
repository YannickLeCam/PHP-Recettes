...
-- Listage des données de la table recipe_demo.ingredient : ~25 rows (environ)
...
-- Listage des données de la table recipe_demo.quantify : ~0 rows (environ)
...
-- Listage des données de la table recipe_demo.type : ~0 rows (environ)
